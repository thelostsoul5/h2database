...
EXPLAIN SELECT ROWID FROM TEST WHERE B = 4;
>> SELECT ROWID FROM "PUBLIC"."TEST" /* PUBLIC.TEST_IDX_1: B = 4 */ WHERE "B" = 4

EXPLAIN SELECT ROWID, A FROM TEST WHERE B = 4;
>> SELECT ROWID, "A" FROM "PUBLIC"."TEST" /* PUBLIC.TEST_IDX_1: B = 4 */ WHERE "B" = 4

EXPLAIN SELECT A FROM TEST WHERE B = 4;
>> SELECT "A" FROM "PUBLIC"."TEST" /* PUBLIC.TEST_IDX_1: B = 4 */ WHERE "B" = 4

SELECT ROWID, A FROM TEST WHERE B = 4;
> ROWID A
> ------- -
> 3       3
> rows: 1
