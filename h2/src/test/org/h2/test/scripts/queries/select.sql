...
CREATE TABLE TEST("ROWID" INT) AS VALUES 2;
> ok

SELECT ROWID S1, TEST.ROWID S2, PUBLIC.TEST.ROWID S3, SCRIPT.PUBLIC.TEST.ROWID S4,
    "ROWID" U1, TEST."ROWID" U2, PUBLIC.TEST."ROWID" U3, SCRIPT.PUBLIC.TEST."ROWID" U4
    FROM TEST;
